...
const Index = () => {
  ...
  return (
    <VStack spacing={8} p={5}>
      ...
      <VStack width="full" mt={4} position="fixed" bottom="0" left="0" right="0" pb={4} bg="white">
        <ButtonGroup isAttached variant="outline" width="full">
          <Button onClick={() => setCurrentHole(currentHole - 1)} isDisabled={currentHole === 0} flex="1">
            Previous Hole
          </Button>
          <Button onClick={() => setCurrentHole(currentHole + 1)} isDisabled={currentHole === 17} flex="1">
            Next Hole
          </Button>
        </ButtonGroup>
      </VStack>
